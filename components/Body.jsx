...
const Body = () =>{
    ...
    <h1>You Are OFfline my dear Friend ! Please Check Your InterNet Connection</h1>
    );
    ...
    return (listOfResturants.length === 0) ? <Shimmer/> : (
        <div className="body">
            <div className="search">
                <input data-testid = "serchinput" className="searchbar" type="text" value={Searchtext} onChange={(e)=>{
             ...
             <div className="filter">
                        <button data-testid="filterbtn" className="filter" onClick={()=>{
                    ...
                    <div className="input">
                        <label htmlFor="username">username</label><input value={logedInUser} onChange={(e)=>setuserName(e.target.value)} type="text" id="username" placeholder="username"/>
                    </div>
                </div>
                   ...
                   <div className="res-container">
                    {filterdRestutrant.map((resturants) => (
                            ...
                            { resturants.info.veg ? (<ResturantCardPromoted resData = {resturants}/>):( <Resturantcard resData = {resturants}/>)}</Link>
